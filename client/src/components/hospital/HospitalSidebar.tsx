    ...
    <>
      ...
      <div className="p-6">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <h1 className="text-lg font-bold text-white">InsureLink</h1>
            <p className="text-green-100 text-xs">Hospital Portal</p>
          </div>
        </div>
      </div>
      ...
      <nav className="mt-6 flex-1 overflow-y-auto">
        <div className="px-6 text-sm">
          ...
          <button
            onClick={() => router.push('/hospital/emergency-contacts')}
            className={`flex items-center w-full px-4 py-2.5 rounded-lg transition-colors mb-2 ${
              isActive('/hospital/emergency-contacts')
                ? 'bg-green-700 text-white'
                : 'text-green-100 hover:bg-green-700 hover:text-white'
            }`}
          >
      ...
      <div className="p-5 border-t border-green-700 text-sm">
        <button
          onClick={handleLogout}
          className="flex items-center w-full px-4 py-2.5 text-green-100 hover:bg-red-600 hover:text-white rounded-lg transition-colors"
        >
          <svg className="w-4 h-4 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
