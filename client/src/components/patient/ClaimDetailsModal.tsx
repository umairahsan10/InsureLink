...
export default function ClaimDetailsModal({
  ...
  const getStatusDisplayName = (status: string) => status;
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
              <div>
                ...
                <span
                  className={`inline-flex px-3 py-1 text-sm font-medium rounded-full border mt-2 ${getStatusColor(
                    claim.status
                  )}`}
                >
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900">
                    {formatDate(claim.dischargeDate)}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
            ...
            {/* Actions for specific intermediate statuses removed — using only Pending/Approved/Rejected */}
          </div>
        </div>
      </div>
    </div>
