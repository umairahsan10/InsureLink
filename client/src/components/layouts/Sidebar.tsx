...
const menuItems: Record<string, MenuItem[]> = {
  ...
  hospital: [
    ...
    { name: "Patients", href: "/hospital/patients", icon: <PatientsIcon /> },
    {
      ...
      href: "/hospital/emergency-contacts",
      icon: <EmergencyContactsIcon />,
    },
    { name: "Visits", href: "/hospital/visits", icon: <VisitsIcon /> },
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${
                ...
                userRole === 'hospital' ? 'bg-green-600' :
                userRole === 'admin' ? 'bg-indigo-600' : 'bg-red-600'
              }`}>
