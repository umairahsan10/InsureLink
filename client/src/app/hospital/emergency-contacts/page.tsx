...
export default function HospitalEmergencyContactsPage() {
  ...
  const contacts = useMemo(
    () => (contactsData as HospitalEmergencyContact[]).sort((a, b) => a.level - b.level),
    []
  );

  const formatTelephoneHref = (number: string) => `tel:${number.replace(/[^+\d]/g, '')}`;
        ...
        <header className="bg-white shadow-sm border-b">
          <div className="px-4 lg:px-6 py-4 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Emergency Contacts</h1>
            ...
            <div className="px-4 lg:px-6 py-5 border-b border-gray-200 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="text-xs lg:text-sm text-gray-600 mt-1">
                  Start from the first point of contact and escalate through the levels if response is delayed.
                </p>
              </div>
            </div>
                      ...
                      <div className="p-5">
                        ...
                        <div className="mt-4 space-y-3 text-sm">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-xs uppercase tracking-wide text-gray-500">Direct Line</p>
                              <a
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">{contact.remarks}</p>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="border-t border-gray-100 bg-gray-50 px-4 lg:px-6 py-5">
              <div className="flex flex-col gap-3 text-xs text-gray-600 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span>Keep a record in the hospital incident log after each escalation attempt.</span>
                </div>
                <a
