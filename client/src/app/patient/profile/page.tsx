        ...
        <div className="lg:col-span-2 bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="email" className="w-full px-3 py-2 border border-gray-300 rounded-lg" defaultValue="john.doe@example.com" />
            </div>
            ...
            <div>
              ...
              <input type="date" className="w-full px-3 py-2 border border-gray-300 rounded-lg" defaultValue="1990-01-01" />
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="font-semibold">POL-2024-001234</p>
            </div>
            <div>
