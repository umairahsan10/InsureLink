...
export class UsersService {
  ...
  async getUserById(
    ...
    this.logger.log(
      `getUserById requested actorId=${actor.id} targetUserId=${id}`,
    );
  ...
  async updateUser(
    ...
    this.logger.log(
      `updateUser requested actorId=${actor.id} targetUserId=${id}`,
    );
    ...
    try {
      ...
      this.logger.log(
        `updateUser succeeded actorId=${actor.id} targetUserId=${id}`,
      );
  ...
  async deleteUser(
    ...
    this.logger.warn(
      `deleteUser requested actorId=${actor.id} targetUserId=${id}`,
    );
    this.ensureElevated(actor);
    ...
    try {
      ...
      this.logger.warn(
        `deleteUser completed actorId=${actor.id} targetUserId=${id}`,
      );
      return { success: true };
    } catch (error: unknown) {
      if (
